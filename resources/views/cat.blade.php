    ...
    <div class="row mb-4">
        <div class="col-12 text-center">
            ...
            <div class="filter-buttons">
                <a href="{{ route('categories.index') }}" class="btn btn-outline-primary m-1 {{ is_null($categoryId) ? 'active' : '' }}">All</a>
            ...
            <div class="col-lg-4 col-md-6 text-center mb-4">
                <div class="single-product-item">
                    <div class="product-image">
                        <a href="#"><img src="{{ asset($product->image_path) }}" alt="{{ $product->name }}" style="width: 200px !important; height: 200px!important; object-fit: cover;"></a>
                    </div>
                    <h3>{{ $product->name }}</h3>
